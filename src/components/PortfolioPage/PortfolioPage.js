...
export default function PortfolioPage(){
   return <div className="PortfolioPage">
            ...
            <section className="Portfolio-grid">
                ...
                <PortfolioCard githubLink = "https://github.com/NoahAldhous/split-the-bill" deployedLink = "https://bill-calculator-ecru.vercel.app/" text = "A Vue app to help people split their restaurant bills. Bult with a mobile-first design." image = {splitTheBill}/>
